...
const { RPC_URL } = require("../constants/constants");
const Multicall = require("@0xsequence/multicall");

const addresses = {
	account: "",
	native: "0x82aF49447D8a07e3bd95BD0d56f35241523fBab1", // wETH
	collateral: "0xFF970A61A04b1cA14834A43f5dE4533eBDDB5CC8", // USDC
	stakedGlp: "0x1aDDD80E6039594eE970E5872D247bf0414C8903",
	glpManager: "0x3963FfC9dff443c2A94f21b129D429891E32ec18",
	vault: "0x489ee077994B6658eAfA855C308275EAd8097C4A",
	feeGlp: "0x4e971a87900b931fF39d1Aad67697F49835400b6",
...
const abis = {
	...
	stakedGlp: [
		{
			inputs: [
				...
				{ internalType: "contract IGlpManager", name: "_glpManager", type: "address" },
		...
		},
		{
			inputs: [],
			name: "glpManager",
			outputs: [{ internalType: "contract IGlpManager", name: "", type: "address" }],
			stateMutability: "view",
			type: "function",
		},
		{
	...
	glpManager: [
		...
		{
			inputs: [
				{ internalType: "contract IShortsTracker", name: "_shortsTracker", type: "address" },
			],
		...
		{
			inputs: [
				{ internalType: "uint256", name: "_shortsTrackerAveragePriceWeight", type: "uint256" },
			],
		...
		},
		{
			inputs: [],
			name: "shortsTracker",
			outputs: [{ internalType: "contract IShortsTracker", name: "", type: "address" }],
			stateMutability: "view",
			type: "function",
		},
		{
	...
	vault: [
		...
		},
		{
			...
			inputs: [
				{ indexed: false, internalType: "address", name: "token", type: "address" },
				{ indexed: false, internalType: "uint256", name: "feeUsd", type: "uint256" },
		...
		},
		{
			...
			inputs: [
				...
				{ indexed: false, internalType: "uint256", name: "amountOut", type: "uint256" },
				{ indexed: false, internalType: "uint256", name: "amountOutAfterFees", type: "uint256" },
				{ indexed: false, internalType: "uint256", name: "feeBasisPoints", type: "uint256" },
			],
			name: "Swap",
			type: "event",
		},
		{
			...
			inputs: [
				{ indexed: false, internalType: "address", name: "token", type: "address" },
				{ indexed: false, internalType: "uint256", name: "fundingRate", type: "uint256" },
			],
		...
		{
			inputs: [{ internalType: "address", name: "_errorController", type: "address" }],
		...
		{
			inputs: [{ internalType: "bool", name: "_inPrivateLiquidationMode", type: "bool" }],
	...
	shortsTracker: [
		...
		},
		{
			...
			inputs: [
				...
				{ indexed: false, internalType: "uint256", name: "globalShortSize", type: "uint256" },
				{
					indexed: false,
		...
		},
		{
			inputs: [
				...
				{ internalType: "uint256[]", name: "_averagePrices", type: "uint256[]" },
			],
			name: "setInitData",
			outputs: [],
			stateMutability: "nonpayable",
		...
		},
		{
			inputs: [
				...
				{ internalType: "bool", name: "_isLong", type: "bool" },
				{ internalType: "uint256", name: "_sizeDelta", type: "uint256" },
				{ internalType: "uint256", name: "_markPrice", type: "uint256" },
				{ internalType: "bool", name: "_isIncrease", type: "bool" },
			],
...
const contracts = {
	...
	stakedGlp: {
		getContract() {
			return new ethers.Contract(addresses.stakedGlp, abis.stakedGlp, provider);
		},
	},
	glpManager: {
		getContract() {
			return new ethers.Contract(addresses.glpManager, abis.glpManager, provider);
		},
	},
	vault: {
		getContract() {
			return new ethers.Contract(addresses.vault, abis.vault, provider);
		},
	},
	rewardTracker: {
		getContract(address) {
			return new ethers.Contract(address, abis.rewardTracker, provider);
		},
	},
	shortsTracker: {
		getContract() {
			return new ethers.Contract(addresses.shortsTracker, abis.shortsTracker, provider);
		},
	},
};
